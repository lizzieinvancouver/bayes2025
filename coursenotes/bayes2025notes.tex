...
\end{enumerate}
\todo[inline]{Ask the class: Why do flip a coin?.} Otherwise your chain gets into crevices and does not search fully, {\bf SEARCHING fully the challenge.} Give the roomba vacuum example.  
